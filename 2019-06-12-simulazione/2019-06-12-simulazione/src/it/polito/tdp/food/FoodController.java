...
public class FoodController {
    ...
    void doCreaGrafo(ActionEvent event) {
    	...
    	if (cal.length()==0)
    	{
    		txtResult.appendText("ERRORE: inserire numero di calorie\n");
    		return;
    	}
    	...
    	try {
    	calorie= Double.parseDouble(cal);} catch(NumberFormatException n) {txtResult.appendText("ERRORE: inserire solo numeri reali\n");
    	return;}

    	String ris= model.creaGrafo(calorie);
